...
class InstaBot:
    ...
    def write_followers_to_csv(self):
        ...
        num_of_followers = self.driver.find_element_by_xpath(
        ...
        try:
            anchor_point = self.driver.find_element_by_css_selector(
                '.PZuss > li:nth-child(1) > div:nth-child(1) > div:nth-child(3) > button:nth-child(1)')
        except:
            anchor_point = self.driver.find_element_by_xpath(
        ...
        num_of_following = self.driver.find_element_by_xpath(
        ...
        self.driver.implicitly_wait(10)
        try:
            following_anchor_point = self.driver.find_element_by_css_selector(
                '.PZuss > li:nth-child(1) > div:nth-child(1) > div:nth-child(3) > button:nth-child(1)')
        except:
        ...
        followings = self.driver.find_elements_by_xpath(
            '/html/body/div[4]/div/div/div[2]/ul/div/li/div/div[1]/div[2]/div[1]/span/a')
